...
class UserSub2 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        if(this.state.render) {
            ...
            <span onClick={ this.unsubscribe() } id="unsubscribe3">UNSUBSCRIBE</span> : 
            <span onClick={ this.subscribe() } id="subscribe3">SUBSCRIBE</span>
        }
        return (
            <>
            { btn }
