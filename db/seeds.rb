...
file1 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/BFH2.jpg")
file2 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/BFHVID1.mp4")
file3 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/BFH.jpg")
file4 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/BHVID2.mp4")
file5 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/lana.jpg")
file6 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/BLUEJEANS.mp4")
file7 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/HALO1.jpg")
file8 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/HALOVID1.mp4")
file9 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/PUBG1.jpg")
file10 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/PUBGVID2.mp4")
file11 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/PUBG2.jpg")
file12 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/PUBGVID1.mp4")
file13 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/HALOREACH.jpeg")
file14 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/HALOVID2.mp4")
file15 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/FIFA1.jpg")
file16 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/FIFAVID3.mp4")
file17 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/FIFA4.jpg")
file18 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/FIFAVID1.mp4")
file19 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/BFH5.jpg")
file20 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/Hardline2.mp4")
file21 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/BFH3.jpg")
file22 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/BFHVID3.mp4")
file23 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/BH4.jpg")
file24 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/BFHVID4.mp4")
file25 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/BFH6.jpg")
file26 = open("https://active-storage-enjoy-pro.s3.amazonaws.com/Hardline1.mp4")
...
videos = Video.create([
    ...
    { title: "PUBG 1-Man Squads", description: "Shoulda captured my other clips, woulda came in handy for this project...but for now...", uploader_id: 1 },
    { title: "PUBG 1-Man Squads 2", description: "Shoulda captured my other clips, woulda came in handy for this project...but for now...", uploader_id: 1 },
